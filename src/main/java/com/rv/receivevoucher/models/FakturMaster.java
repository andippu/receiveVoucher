...
@AllArgsConstructor
@Entity
@Table(name = "FAKTUR_MASTER")
public class FakturMaster {
    ...
    @Column(name="FM_DOWNPAYMENT")
    private BigDecimal fmDownPayment;

    @Column(name="FM_MSO_SEQ")
    private Integer fmMsoSeq;
